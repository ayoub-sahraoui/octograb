...
export class ExtractScopeBlock extends BlockBase {
    ...
    constructor(name: string, config: ExtractScopeBlockConfig) {
        ...
        makeObservable(this, {
            ...
            addField: action,
            removeField: action,
            removeFieldByIndex: action,
            updateField: action,
            updateFieldByIndex: action,
            ensureFieldIds: action,
            addTransformer: action,
            removeTransformer: action,
            updateTransformer: action,
            setScopeSelector: action,
            setResetScope: action,
        });
        this.id = uuidv4();
        this.label = name;
        this.enabled = true;
